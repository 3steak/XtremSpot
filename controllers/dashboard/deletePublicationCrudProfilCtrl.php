...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($error)) {
        try {
            ...
            if ($result) {
                ...
                try {
                    ...
                    $mail->Body    = 'Votre publication n\'a pas été validé pour ce motif, ' . $refuseMsg . ', veuillez respecter les règles d\'utilisation du site !<br> Belle journée ! ';
        ...
        include(__DIR__ . '/../../views/dashboard/usersListCtrl.php');
    }
}
