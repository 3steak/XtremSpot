                ...
                <div class="col-11 m-4">
                    ...
                    <div class="cardSettings  d-flex justify-content-center m-4 p-2">
                        <div class="row gap-5">
                            ...
                            <!---  darkmode row --->
                            <div class="darkMode d-flex justify-content-center gap-4">
                                <h2 class="text-white">Mode</h2>
                                <button type="button" class="btn btn-dark  text-white btnDark">Sombre</button>
                                <button type="button" class="btn btn-light  btnLight">Clair</button>
                            </div>
                        </div>
                    </div>
                </div>
